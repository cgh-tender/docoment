...
/** 滚动条组件元素的引用 */
const scrollbarRef = ref<{ scrollEl: HTMLDivElement }>()
/** 滚动条内容元素的引用 */
...
<template>
  <div class="scroll-container">
    ...
    <!--    <perfect-scrollbar ref="scrollbarRef" @wheel.passive="wheelScroll" @scroll="scroll">-->
    <perfect-scrollbar
      ref="scrollbarRef"
      style="width: calc(100vw - var(--v3-sidebar-width) - var(--v3-sidebar-hide-width)); flex: 1"
    >
