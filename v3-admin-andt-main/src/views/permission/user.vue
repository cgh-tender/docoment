...
<template>
  <div class="app-container" v-loading="loading">
    ...
    <a-card shadow="never">
      <a-table border :data="tableData">
        <a-table-column type="selection" width="50" align="center" />
        <a-table-column fixed prop="username" label="账号" align="center" />
        <a-table-column prop="realname" label="用户名" align="center" />
        <a-table-column prop="phone" label="手机" align="center" />
        <a-table-column prop="email" label="邮箱" align="center" />
        <a-table-column prop="gender" label="性别" align="center" />
        <a-table-column prop="status" label="状态" align="center">
    ...
    <!-- 新增/修改 -->
    <transition name="a-zoom-in-center">
...
.a-button.is-text:not(.is-disabled):focus-visible {
  outline: unset;
}
