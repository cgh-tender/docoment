...
<template>
  <div class="app-container">
    ...
    <a-button-group>
      ...
      <a-button type="warning" @click="setWatermark('没有防御功能的局部水印', { color: '#e6a23c', defense: false })">
        关闭防御功能
      </a-button>
      <a-button type="danger" @click="clearWatermark">清除局部水印</a-button>
    </a-button-group>
    <a-button-group>
      ...
      <a-button type="danger" @click="clearGlobalWatermark">清除全局水印</a-button>
    </a-button-group>
  </div>
</template>
