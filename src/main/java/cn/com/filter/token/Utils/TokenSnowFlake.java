package cn.com.filter.token.Utils;
...
public class TokenSnowFlake {
     ...
     */
    public TokenSnowFlake(long workerId, long datacenterId) {
...
//                        return sb.toString().toUpperCase();
    ...
    public static void main(String[] args) {
        TokenSnowFlake snowFlake = new TokenSnowFlake();
        log.info(twepoch);
