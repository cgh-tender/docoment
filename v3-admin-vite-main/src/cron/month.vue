<template lang="html">
  <div :val="value_">
    <div>
      <el-radio v-model="type" label="1" size="small" border>每月</el-radio>
    </div>
    <div>
    ...
    <div>
      ...
      <el-input-number @change="type = '2'" v-model="cycle.start" :min="1" :max="12" size="small" style="width: 100px" />
      <span style="margin-left: 5px; margin-right: 5px">至</span>
      <el-input-number @change="type = '2'" v-model="cycle.end" :min="2" :max="12" size="small" style="width: 100px" />
      月
    </div>
    <div>
      <el-radio v-model="type" label="3" size="small" border>循环</el-radio>
      <span style="margin-left: 10px; margin-right: 5px">从</span>
      <el-input-number @change="type = '3'" v-model="loop.start" :min="1" :max="12" size="small" style="width: 100px" />
      <span style="margin-left: 5px; margin-right: 5px">月开始，每</span>
      <el-input-number @change="type = '3'" v-model="loop.end" :min="1" :max="12" size="small" style="width: 100px" />
      月执行一次
    </div>
    <div>
