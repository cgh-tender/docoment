...
<template>
  <div class="vue3-cron-div">
    <div style="margin-bottom: 20px">
      <el-radio-group v-model="sysRadio">
        <el-radio-button :label="1" size="small">Linux</el-radio-button>
        <el-radio-button :label="2" size="small">Java(Spring)</el-radio-button>
        <el-radio-button :label="3" size="small">Java(Quartz)</el-radio-button>
      </el-radio-group>
    </div>
    <el-tabs type="border-card">
      <el-tab-pane v-if="showSecond">
        <template #label>
        ...
        <div class="tabBody myScroller" :style="{ 'max-height': maxHeight }">
          ...
          <el-row>
            ...
            <el-select size="small" multiple v-model="state.second.specificSpecific" style="width: 40%">
      ...
      <el-tab-pane>
        ...
        <div class="tabBody myScroller" :style="{ 'max-height': maxHeight }">
          ...
          <el-row>
            ...
            <el-select size="small" multiple v-model="state.minute.specificSpecific" style="width: 40%">
              <el-option v-for="(val, index) in 60" :key="index" :value="val - 1">{{ val - 1 }}</el-option>
            </el-select>
          </el-row>
          <el-row>
      ...
      <el-tab-pane>
        ...
        <div class="tabBody myScroller" :style="{ 'max-height': maxHeight }">
          ...
          <el-row>
            ...
            <el-select size="small" multiple v-model="state.hour.specificSpecific" style="width: 40%">
      ...
      <el-tab-pane>
        ...
        <div class="tabBody myScroller" :style="{ 'max-height': maxHeight }">
          ...
          <el-row>
            ...
            <el-select size="small" v-model="state.week.incrementStart" style="width: 40%">
          ...
          <el-row>
            ...
            <el-select size="small" multiple v-model="state.week.specificSpecific" style="width: 40%">
              <el-option
          ...
          <el-row>
            ...
            <el-select size="small" multiple v-model="state.day.specificSpecific" style="width: 40%">
          ...
          <el-row>
            ...
            <el-select size="small" v-model="state.day.cronLastSpecificDomDay" style="width: 40%">
              <el-option v-for="(val, index) in 7" :key="index" :label="state.text?.Week[val - 1]" :value="val" />
            </el-select>
          </el-row>
          <el-row>
          ...
          <el-row>
            ...
            <el-select size="small" v-model="state.week.cronNthDayDay" style="width: 40%">
              <el-option v-for="(val, index) in 7" :key="index" :label="state.text?.Week[val - 1]" :value="val" />
            </el-select>
          </el-row>
        </div>
      ...
      <el-tab-pane>
        ...
        <div class="tabBody myScroller" :style="{ 'max-height': props.maxHeight }">
          ...
          <el-row>
            ...
            <el-select size="small" multiple v-model="state.month.specificSpecific" style="width: 40%">
      ...
      <el-tab-pane v-if="showYear">
        ...
        <div class="tabBody myScroller" :style="{ 'max-height': maxHeight }">
          ...
          <el-row>
            ...
            <el-select size="small" filterable multiple v-model="state.year.specificSpecific" style="width: 40%">
    ...
    <div class="bottom">
      ...
      <div class="buttonDiv">
        <el-radio-button type="primary" size="small" @click.stop="handleChange">{{ state.text?.Save }}</el-radio-button>
        <el-radio-button type="primary" size="small" @click="close">{{ state.text?.Close }}</el-radio-button>
      </div>
    </div>
  </div>
</template>
